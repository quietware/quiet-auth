...
import dev.calmauth.domain.PinProtectionMigration
...
class PinRepository(private val storage: SecureStorage) {
    ...
    companion object {
        ...
        const val KEY_PIN_ENABLED = "calmauth_pin_enabled_v1"
        const val KEY_ONBOARDING_COMPLETED = "calmauth_onboarding_completed_v1"
